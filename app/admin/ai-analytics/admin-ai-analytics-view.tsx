  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">{t.admin.aiAnalytics.mongoEmbeddingsStorage}</CardTitle>
            <Database className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{t.admin.aiAnalytics.embeddingsStorageActive}</div>
            <p className="text-xs text-muted-foreground">{t.admin.aiAnalytics.embeddingsStorageSub}</p>
          </CardContent>
        </Card>
      </div>
