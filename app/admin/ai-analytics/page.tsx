...
const matchDistributionData = [
  { name: 'No data', value: 1 }, // Fallback empty state
];
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">0%</div>
            <p className="text-xs text-muted-foreground">For accepted applications</p>
          </CardContent>
        </Card>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Precision and Recall over the last 4 weeks</CardDescription>
          </CardHeader>
